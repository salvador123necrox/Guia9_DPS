...
class PantallaInicio extends React.Component {
  ...
  Entrar() {
    if (!!this.state.usuario && !!this.state.contrasena) {
      fetch('https://guia09dps.000webhostapp.com/apiusuario.php?comando=autenticar&usuario='+this.state.usuario+'&contrasena='+this.state.contrasena, {
method: 'GET'
})
  ...
  return (
    <View style={{ flex: 1, padding: 10 }}>
      ...
      <Image
        ...
        source={require('./imagenes/store.jpg')}
      />
...
class listarProductos extends React.Component {
  ...
  cargarRegistros() {
    console.log('Prueba');
    fetch('https://guia09dps.000webhostapp.com/api.php?comando=listar', {
      method: 'GET'
    })
      .then((response) => response.json())
      .then((responseJson) => {
...
class PaginaDetalle extends React.Component {
  ...
  Actualizar() {
    fetch('https://guia09dps.000webhostapp.com/api.php?comando=editar&nombre=' + this.state.nombre
  ...
  Eliminar() {
    fetch('https://guia09dps.000webhostapp.com/api.php?comando=eliminar&id=' + this
      .state.id, {
      method: 'GET'
    })
      .then((response) => response.json())
...
class PaginaAgregar extends React.Component {
  ...
  Guardar() {
    fetch('https://guia09dps.000webhostapp.com/api.php?comando=agregar&nombre=' + this.state.nombre
      + '&descripcion=' + this.state.descripcion
      + '&cantidad=' + this.state.cantidad
      + '&preciodecosto=' + this.state.preciodecosto
      + '&preciodeventa=' + this.state.preciodeventa
